...
class ManageDoctor extends Component {
    ...
    handleSaveContentMarkdown = () => {
        ...
        this.props.saveDetailDoctorAction({
            ...
            clinicId: this.state.selectedClinic && this.state.selectedClinic.value ? this.state.selectedClinic.value : '', //lấy id
            specialtyId: this.state.selectedSpecialty.value   //lấy id
    ...
    // selected price, payment, province,specialty , clinic
